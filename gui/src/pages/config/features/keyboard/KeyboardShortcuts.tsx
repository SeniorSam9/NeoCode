...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close NeoCode Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close NeoCode Sidebar If Chat Already In Focus",
  },
  {
